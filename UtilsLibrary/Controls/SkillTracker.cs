...
{
    public enum SkillTrackerStyle : uint
    {
        BarAndBox,
        BarOnly,
        BoxOnly
    ...
    public partial class SkillTracker : UserControl
    {
        ...
        private SkillTrackerStyle style = SkillTrackerStyle.BarAndBox;

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public SkillTrackerStyle Style
        {
            get => style;
            set
            {
                if (style != value)
                {
                    ...
                    switch (style)
                    {
                        case SkillTrackerStyle.BarAndBox:
                            ...
                            break;
                        case SkillTrackerStyle.BarOnly:
                            trackBar.Visible = true;
                            trackBar.Size = new Size(138, trackBar.Size.Height);

                            textBox.Visible = false;
                            break;
                        case SkillTrackerStyle.BoxOnly:
        ...
        private uint tokenProp = 0;

        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public uint TokenProp
        {
            get => tokenProp;
            set => tokenProp = value;
        }
        ...
        public ushort Value
        {
            ...
            set
            {
                if (value != NO_VALUE)
                {
                    ...
                    textBox.Value = (value / (Maximum / 10.0f));
                }
                else
                {
                    trackBar.Value = 0;
        ...
        private void OnTrackBarChanged(object sender, System.EventArgs e)
        {
            ...
            internalChange = true;
            textBox.Value = trackBar.Value / (Maximum / 10.0f);
        ...
        private void OnTextBoxChanged(object sender, System.EventArgs e)
        {
            ...
            internalChange = true;
            trackBar.Value = (int)(textBox.Value * (Maximum / 10.0f));
            internalChange = false;
        }
    }
}
