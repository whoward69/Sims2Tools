...
namespace Sims2Tools.Controls
{
    ...
    public partial class SecretLotButton : UserControl
    {
        public SecretLotButton()
        {
            InitializeComponent();

            iconSecretLot.Parent = button;
        }
        ...
        private void OnSecretLotIconClicked(object sender, EventArgs e)
        {
            button.PerformClick();
        }
    }
